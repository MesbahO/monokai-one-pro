...
local M = {
  ...
  context_class = { fg = c.base.yellow },
  context_constant = { fg = c.base.white },
  context_constructor = { fg = c.base.yellow },
  ...
  context_function = { fg = c.base.magenta },
  context_interface = { fg = c.base.yellow },
  context_key = { fg = c.base.blue },
  context_method = { fg = c.base.magenta },
  context_module = { fg = c.base.cyan },
  context_namespace = { fg = c.base.cyan },
  context_null = { fg = c.base.blue },
  context_number = { fg = c.base.blue },
  context_object = { fg = c.base.cyan },
  context_operator = { fg = c.base.red },
  context_package = { fg = c.base.magenta },
  context_property = { fg = c.base.white },
  context_string = { fg = c.base.green },
  context_struct = { fg = c.base.red },
  context_type_parameter = { fg = c.base.white },
  context_variable = { fg = c.base.white },
}
