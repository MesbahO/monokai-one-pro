...
M.setup = function(c, config, _)
  ...
  return {
    ...
    Function = { fg = c.base.magenta }, -- function name (also: methods for classes)
    Statement = { fg = c.base.white }, -- (preferred) any statement
    ...
    Type = { fg = c.base.yellow }, -- React, ReactDOM (import React from 'react';)
